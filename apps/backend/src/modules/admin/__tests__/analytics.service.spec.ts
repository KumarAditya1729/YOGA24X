...
describe('AnalyticsService', () => {
  ...
  it('should compute platform metrics correctly', async () => {
    ...
    mockPrisma.settlementBatch.aggregate.mockResolvedValue({ _sum: { totalCents: 5000000 } });
  ...
  it('should return 0 revenue when no settled batches', async () => {
    ...
    mockPrisma.settlementBatch.aggregate.mockResolvedValue({ _sum: { totalCents: null } });
