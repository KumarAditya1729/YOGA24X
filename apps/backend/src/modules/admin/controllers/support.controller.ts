...
export class SupportController {
  ...
  async getTickets(@Query('status') status?: TicketStatus, @Query('priority') priority?: TicketPriority) {
  ...
  async createTicket(@Body() body: {
    ...
    return this.supportService.createTicket(
      body.userId, body.subject, body.description, body.priority
    );
  }
  ...
  async addComment(
    ...
    return this.supportService.addComment(id, body.userId, body.content, body.isInternal);
  }
