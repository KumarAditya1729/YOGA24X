...
export class CommerceAnalyticsController {
  ...
  getMRR() { return this.analyticsService.getMRR(); }

  @Get('arr')
  @RequirePermissions(PERMISSIONS.COMMERCE_ANALYTICS_READ)
  @ApiOperation({ summary: 'Annual Recurring Revenue' })
  getARR() { return this.analyticsService.getARR(); }

  @Get('arpu')
  @RequirePermissions(PERMISSIONS.COMMERCE_ANALYTICS_READ)
  @ApiOperation({ summary: 'Average Revenue Per User' })
  getARPU() { return this.analyticsService.getARPU(); }

  @Get('funnel')
  @RequirePermissions(PERMISSIONS.COMMERCE_ANALYTICS_READ)
  @ApiOperation({ summary: 'Conversion funnel analytics' })
  getConversionFunnel() { return this.analyticsService.getConversionFunnel(); }

  @Get('subscriptions/active')
  @RequirePermissions(PERMISSIONS.COMMERCE_ANALYTICS_READ)
  @ApiOperation({ summary: 'Count of active subscriptions' })
  getActiveSubscriptions() { return this.analyticsService.getActiveSubscriptions(); }

  @Get('memberships/active')
  @RequirePermissions(PERMISSIONS.COMMERCE_ANALYTICS_READ)
  @ApiOperation({ summary: 'Count of active memberships' })
  getActiveMemberships() { return this.analyticsService.getActiveMemberships(); }
