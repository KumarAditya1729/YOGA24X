import {
  IsString, IsInt, IsOptional, IsEnum, IsBoolean, IsArray,
  IsUUID, Min, IsDateString, IsNumber,
} from 'class-validator';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import {
  MembershipType, CouponType, RefundReason, RevenueShareType, PricingRuleType,
} from '@prisma/client';
...
export class CreateMembershipPlanDto {
  ...
  @ApiProperty({ enum: MembershipType }) @IsEnum(MembershipType)
...
export class RequestRefundDto {
  ...
  @ApiProperty({ enum: RefundReason }) @IsEnum(RefundReason)
  reason: RefundReason;
...
export class ProcessRefundDto {
  ...
  @ApiProperty({ enum: ['APPROVED', 'REJECTED'] }) @IsString()
...
export class CreateRevenueShareRuleDto {
  ...
  @ApiProperty({ enum: RevenueShareType }) @IsEnum(RevenueShareType)
...
export class CreatePricingRuleDto {
  ...
  @ApiProperty({ enum: PricingRuleType }) @IsEnum(PricingRuleType)
