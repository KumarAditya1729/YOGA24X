...
import { RequirePermissions, RequireRoles } from '../decorators/authorization.decorators';
...
export class RolesController {
  ...
  @Get('system')
  @ApiOperation({ summary: 'Get all system role definitions with permission matrix' })
  ...
  @Post('overrides')
  @ApiOperation({ summary: 'Grant permission override (allow/deny/temporary/conditional)' })
  @RequirePermissions(PERMISSIONS.SECURITY_PERMS_MANAGE)
  @HttpCode(HttpStatus.CREATED)
  grantOverride(@Body() body: {
    userId: string;
