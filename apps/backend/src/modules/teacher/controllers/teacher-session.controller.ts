...
export class TeacherSessionController {
  ...
  async createSessionType(@CurrentUser() user: JwtPayload, @Body() data: CreateTeacherSessionTypeDto) {
  ...
  async updateSessionType(@CurrentUser() user: JwtPayload, @Param('id') id: string, @Body() data: UpdateTeacherSessionTypeDto) {
  ...
  async deleteSessionType(@CurrentUser() user: JwtPayload, @Param('id') id: string) {
  ...
  async createPricingRule(@CurrentUser() user: JwtPayload, @Body() data: CreateTeacherPricingRuleDto) {
  ...
  async deletePricingRule(@CurrentUser() user: JwtPayload, @Param('id') id: string) {
  ...
  async createSession(@CurrentUser() user: JwtPayload, @Body() data: CreateTeacherSessionDto) {
