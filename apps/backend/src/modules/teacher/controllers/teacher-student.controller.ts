...
import { UpdateRosterDto, CreateStudentNoteDto, MarkAttendanceDto } from '../dto/teacher-operations.dto';
...
export class TeacherStudentController {
  ...
  async getRosterDetail(@CurrentUser() user: JwtPayload, @Param('studentId') studentId: string) {
  ...
  async updateRoster(@CurrentUser() user: JwtPayload, @Param('studentId') studentId: string, @Body() data: UpdateRosterDto) {
  ...
  async createNote(@CurrentUser() user: JwtPayload, @Param('studentId') studentId: string, @Body() data: CreateStudentNoteDto) {
  ...
  async markAttendance(@CurrentUser() user: JwtPayload, @Param('bookingId') bookingId: string, @Body() data: MarkAttendanceDto) {
