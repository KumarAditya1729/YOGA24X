...
export class AdminWellnessController {
  ...
  @Get('risk-dashboard')
  @ApiOperation({ summary: 'Get enterprise wellness risk dashboard and critical alerts' })
  ...
  @Get('analytics')
  @ApiOperation({ summary: 'Get enterprise wellness assessment analytics and score averages' })
  async getAssessmentAnalytics() {
    return this.adminWellnessService.getAssessmentAnalytics();
  }

  @Get('viewer/:userId')
  @ApiOperation({ summary: 'Admin health profile viewer with full medical safety flags' })
