...
export class HealthProfileRepository {
  ...
  async upsertHealthProfile(userId: string, dto: UpdateHealthProfileDto): Promise<any> {
    const dataToUpdate: any = {};
    if (dto.bloodGroup !== undefined) dataToUpdate.bloodGroup = dto.bloodGroup;
    if (dto.emergencyContactName !== undefined) dataToUpdate.emergencyContactName = dto.emergencyContactName;
    if (dto.emergencyContactPhone !== undefined) dataToUpdate.emergencyContactPhone = dto.emergencyContactPhone;
    if (dto.emergencyContactRelation !== undefined) dataToUpdate.emergencyContactRelation = dto.emergencyContactRelation;
    if (dto.pregnancyStatus !== undefined) dataToUpdate.pregnancyStatus = dto.pregnancyStatus;
    if (dto.medicalHistory !== undefined) dataToUpdate.medicalHistoryJson = dto.medicalHistory;
    if (dto.currentConditions !== undefined) dataToUpdate.currentConditionsJson = dto.currentConditions;
    if (dto.pastConditions !== undefined) dataToUpdate.pastConditionsJson = dto.pastConditions;
    if (dto.surgeries !== undefined) dataToUpdate.surgeriesJson = dto.surgeries;
    if (dto.medications !== undefined) dataToUpdate.medicationsJson = dto.medications;
    if (dto.allergies !== undefined) dataToUpdate.allergiesJson = dto.allergies;
    if (dto.physicalLimitations !== undefined) dataToUpdate.physicalLimitationsJson = dto.physicalLimitations;
  ...
  async verifyByDoctor(userId: string, doctorId: string, notes: string): Promise<any> {
