...
export class WellnessAssessmentRepository {
  ...
  async createWellnessAssessment(userId: string, dto: SubmitWellnessAssessmentDto): Promise<any> {
  ...
  async upsertYogaAssessment(userId: string, dto: UpdateYogaAssessmentDto): Promise<any> {
    const data: any = {};
    ...
    if (dto.preferredYogaStyle !== undefined) data.preferredYogaStyle = dto.preferredYogaStyle;
    if (dto.preferredSessionLengthMin !== undefined) data.preferredSessionLengthMin = dto.preferredSessionLengthMin;
    if (dto.preferredInstructorGender !== undefined) data.preferredInstructorGender = dto.preferredInstructorGender;
    if (dto.practiceFrequencyPerWeek !== undefined) data.practiceFrequencyPerWeek = dto.practiceFrequencyPerWeek;
    if (dto.favoriteTeachers !== undefined) data.favoriteTeachersJson = dto.favoriteTeachers;
    if (dto.favoriteCourses !== undefined) data.favoriteCoursesJson = dto.favoriteCourses;
    if (dto.favoriteMusic !== undefined) data.favoriteMusicJson = dto.favoriteMusic;
    if (dto.preferredPracticeTime !== undefined) data.preferredPracticeTime = dto.preferredPracticeTime;
  ...
  async upsertNutritionProfile(userId: string, dto: UpdateNutritionProfileDto): Promise<any> {
    const data: any = {};
    if (dto.dietType !== undefined) data.dietType = dto.dietType;
    if (dto.dailyCaloriesGoal !== undefined) data.dailyCaloriesGoal = dto.dailyCaloriesGoal;
    if (dto.dailyProteinGoalGrams !== undefined) data.dailyProteinGoalGrams = dto.dailyProteinGoalGrams;
    if (dto.dailyWaterGoalMl !== undefined) data.dailyWaterGoalMl = dto.dailyWaterGoalMl;
    if (dto.foodAllergies !== undefined) data.foodAllergiesJson = dto.foodAllergies;
    if (dto.foodPreferences !== undefined) data.foodPreferencesJson = dto.foodPreferences;
    ...
    return this.prisma.nutritionProfile.upsert({
      ...
      create: {
        ...
        mealTimingJson: dto.mealTiming || { breakfast: '08:00', lunch: '13:00', dinner: '19:00' },
  ...
  async upsertMeditationProfile(userId: string, dto: UpdateMeditationProfileDto): Promise<any> {
    const data: any = {};
    if (dto.meditationExperience !== undefined) data.meditationExperience = dto.meditationExperience;
    if (dto.preferredDurationMin !== undefined) data.preferredDurationMin = dto.preferredDurationMin;
    if (dto.preferredVoice !== undefined) data.preferredVoice = dto.preferredVoice;
    if (dto.preferredMusic !== undefined) data.preferredMusic = dto.preferredMusic;
    if (dto.focusArea !== undefined) data.focusArea = dto.focusArea;
    if (dto.mindfulnessGoals !== undefined) data.mindfulnessGoalsJson = dto.mindfulnessGoals;
    ...
    return this.prisma.meditationProfile.upsert({
      ...
      create: {
        ...
        mindfulnessGoalsJson: dto.mindfulnessGoals || ['STRESS_REDUCTION', 'BETTER_FOCUS'],
      },
    });
  }
  ...
  async getAiPersonalization(userId: string): Promise<any | null> {
    return this.prisma.aiPersonalizationProfile.findUnique({ where: { userId } });
  }

  async upsertAiPersonalization(userId: string, dto: UpdateAiPersonalizationDto): Promise<any> {
    const data: any = {};
    if (dto.coachingStyle !== undefined) data.coachingStyle = dto.coachingStyle;
    if (dto.motivationStyle !== undefined) data.motivationStyle = dto.motivationStyle;
    if (dto.reminderStyle !== undefined) data.reminderStyle = dto.reminderStyle;
    if (dto.communicationTone !== undefined) data.communicationTone = dto.communicationTone;
    if (dto.preferredLanguage !== undefined) data.preferredLanguage = dto.preferredLanguage;
    if (dto.difficultyProgression !== undefined) data.difficultyProgression = dto.difficultyProgression;
    if (dto.learningStyle !== undefined) data.learningStyle = dto.learningStyle;
    if (dto.voicePreference !== undefined) data.voicePreference = dto.voicePreference;
    if (dto.notificationBehaviour !== undefined) data.notificationBehaviour = dto.notificationBehaviour;
    if (dto.recommendationPreferences !== undefined) data.recommendationPreferencesJson = dto.recommendationPreferences;
    ...
    return this.prisma.aiPersonalizationProfile.upsert({
      ...
      create: {
        ...
        recommendationPreferencesJson: dto.recommendationPreferences || { poseCorrectionSensitivity: 'HIGH', pacingPreference: 'MODERATE' },
      },
    });
  }
}
