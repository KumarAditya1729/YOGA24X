...
export const DeviceInfoSchema = z.object({
  ...
  deviceType: z.enum(['MOBILE_IOS', 'MOBILE_ANDROID', 'WEB_BROWSER', 'DESKTOP', 'TABLET']),
...
export const RegisterDtoSchema = z.object({
  ...
  phoneNumber: z.string().regex(/^\+?[1-9]\d{6,14}$/, 'Invalid international phone number').optional(),
...
export type AdminAccountControlDto = z.infer<typeof AdminAccountControlDtoSchema>;
